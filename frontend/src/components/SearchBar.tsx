...
export const SearchBar = () => {
  ...
  return (
    <form
      ...
      className="-mt-8 p-3 bg-orange-400 mx-2 md:mx-0  rounded shadow-md grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 items-center gap-4"
    >
      <div className="flex flex-row items-center flex-1 bg-white p-2">
        ...
        <input
          ...
          value={destination}
          onChange={(event) => setDestinaiton(event.target.value)}
        />
      </div>
